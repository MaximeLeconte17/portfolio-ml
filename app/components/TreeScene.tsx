...
//     // --- BUILD UNIFORMS PROPERLY USING UniformsUtils.merge ---
...
//       // these will be filled later with bbox values
//       uBoxMin: { value: new THREE.Vector3(0, 0, 0) },
//       uBoxSize: { value: new THREE.Vector3(1, 1, 1) },
//     } as Record<string, { value: any }>;

//     // Merge common uniforms, lights, and our custom ones
//     const baseUniforms: THREE.IUniform = (THREE.UniformsUtils as any).merge([
...
//             map:
//               (poleMesh.material as THREE.MeshStandardMaterial)?.map ??
//               undefined,
//           });
...
//           const uniformsAny = leavesMaterial.uniforms as THREE.IUniform &
//             Record<string, any>;

//           if (
//             uniformsAny.uBoxMin &&
//             typeof uniformsAny.uBoxMin.value?.copy === "function"
//           ) {
//             uniformsAny.uBoxMin.value.copy(bbox.min);
//           } else {
//             uniformsAny.uBoxMin = { value: bbox.min.clone() };
//           }

//           if (
//             uniformsAny.uBoxSize &&
//             typeof uniformsAny.uBoxSize.value?.copy === "function"
//           ) {
//             uniformsAny.uBoxSize.value.copy(bbox.getSize(new THREE.Vector3()));
//           } else {
//             uniformsAny.uBoxSize = { value: bbox.getSize(new THREE.Vector3()) };
//           }
...
//         const uRay = (leavesMaterial.uniforms as any)?.uRaycast;
...
//       // update shader time
//       const uTime = (leavesMaterial.uniforms as any)?.uTime;
...
//     <div
//       ref={mountRef}
//       style={{ width: "300px", height: "300px", right: "0" }}
//     />
//   );
// }
